...
class VisaTextRichText extends StatelessWidget {
                ...
                child: Semantics(
                  ...
                  child: RichText(
                    textScaler: TextScaler.linear(
                        Utils.getCappedScale(context, AppSizes.fontMedium)),
                    text: TextSpan(
                      children: textSpans
                          .map((span) => span.getTextSpan(
...
class VisaTextSpan {
  ...
  InlineSpan getTextSpan(bool isDarkMode, BuildContext context) {
    ...
    if (iconPath.isNullOrEmpty) {
      return TextSpan(style: textStyle, children: [
        TextSpan(
          text: text,
        ...
        WidgetSpan(child: SizedBox(height: spacing.h)),
      ]);
    }
