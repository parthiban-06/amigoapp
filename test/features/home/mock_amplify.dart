...
// in visaamigo/test/test_ui/test_login.dart.
...
class _FakeCognitoSignInResult_6 extends _i1.SmartFake
  ...
  _FakeCognitoSignInResult_6(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class _FakeUpdateUserAttributeResult_8 extends _i1.SmartFake
  ...
  _FakeUpdateUserAttributeResult_8(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}

class _FakeConfirmUserAttributeResult_9 extends _i1.SmartFake
    implements _i4.ConfirmUserAttributeResult {
  _FakeConfirmUserAttributeResult_9(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class MockAmplifyAuthCognito extends _i1.Mock
  ...
  @override
  _i2.CognitoAuthStateMachine get stateMachine =>
      (super.noSuchMethod(
  ...
  set stateMachine(_i2.CognitoAuthStateMachine? stateMachine) =>
      super.noSuchMethod(
        Invocation.setter(#stateMachine, stateMachine),
        returnValueForMissingStub: null,
      );

  @override
  _i3.Category get category =>
      (super.noSuchMethod(
  ...
  @override
  _i3.DependencyManager get dependencies =>
      (super.noSuchMethod(
  ...
  @override
  _i3.AmplifyLogger get logger =>
      (super.noSuchMethod(
        Invocation.getter(#logger),
        returnValue: _FakeAmplifyLogger_2(this, Invocation.getter(#logger)),
      )
  ...
  _i7.Future<_i4.CognitoAuthSession> fetchAuthSession({
    _i4.FetchAuthSessionOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#fetchAuthSession, [], {#options: options}),
        returnValue: _i7.Future<_i4.CognitoAuthSession>.value(
  ...
  _i7.Future<_i4.FederateToIdentityPoolResult> federateToIdentityPool({
    ...
    _i4.FederateToIdentityPoolOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#federateToIdentityPool, [], {
          #token: token,
          #provider: provider,
          #options: options,
        }),
  ...
  @override
  _i7.Future<void> clearFederationToIdentityPool() =>
      (super.noSuchMethod(
        Invocation.method(#clearFederationToIdentityPool, []),
        returnValue: _i7.Future<void>.value(),
        returnValueForMissingStub: _i7.Future<void>.value(),
      )
      as _i7.Future<void>);
  ...
  _i7.Future<_i4.CognitoSignInResult> signInWithWebUI({
    ...
    _i4.SignInWithWebUIOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#signInWithWebUI, [], {
          #provider: provider,
          #options: options,
        }),
  ...
  _i7.Future<_i4.CognitoResendSignUpCodeResult> resendSignUpCode({
    ...
    _i4.ResendSignUpCodeOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#resendSignUpCode, [], {
          #username: username,
          #options: options,
        }),
  ...
  _i7.Future<_i4.CognitoSignInResult> confirmSignIn({
    ...
    _i4.ConfirmSignInOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#confirmSignIn, [], {
  ...
  _i7.Future<List<_i4.AuthUserAttribute>> fetchUserAttributes({
    _i4.FetchUserAttributesOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#fetchUserAttributes, [], {#options: options}),
  ...
  _i7.Future<_i4.UpdateUserAttributeResult> updateUserAttribute({
    ...
    _i4.UpdateUserAttributeOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#updateUserAttribute, [], {
  ...
  _i7.Future<_i4.ConfirmUserAttributeResult> confirmUserAttribute({
    ...
    _i4.ConfirmUserAttributeOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#confirmUserAttribute, [], {
          #userAttributeKey: userAttributeKey,
          #confirmationCode: confirmationCode,
          #options: options,
        }),
  ...
  sendUserAttributeVerificationCode({
    ...
    _i4.SendUserAttributeVerificationCodeOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#sendUserAttributeVerificationCode, [], {
          #userAttributeKey: userAttributeKey,
          #options: options,
        }),
        returnValue:
  ...
  _i7.Future<_i4.CognitoAuthUser> getCurrentUser({
    _i4.GetCurrentUserOptions? options,
      ...
      (super.noSuchMethod(
        Invocation.method(#getCurrentUser, [], {#options: options}),
        returnValue: _i7.Future<_i4.CognitoAuthUser>.value(
  ...
  @override
  _i7.Future<_i4.UserMfaPreference> fetchMfaPreference() =>
      (super.noSuchMethod(
        Invocation.method(#fetchMfaPreference, []),
  ...
  _i7.Future<void> updateMfaPreference({
    ...
    _i4.MfaPreference? email,
      ...
      (super.noSuchMethod(
        Invocation.method(#updateMfaPreference, [], {
          #sms: sms,
          #totp: totp,
          #email: email,
        }),
  ...
  _i7.Future<_i4.TotpSetupDetails> setUpTotp({_i4.TotpSetupOptions? options}) =>
      (super.noSuchMethod(
        Invocation.method(#setUpTotp, [], {#options: options}),
        returnValue: _i7.Future<_i4.TotpSetupDetails>.value(
  ...
  @override
  _i7.Future<void> rememberDevice() =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<_i4.CognitoDevice> fetchCurrentDevice() =>
      (super.noSuchMethod(
        Invocation.method(#fetchCurrentDevice, []),
        returnValue: _i7.Future<_i4.CognitoDevice>.value(
  ...
  @override
  _i7.Future<List<_i4.CognitoDevice>> fetchDevices() =>
      (super.noSuchMethod(
        Invocation.method(#fetchDevices, []),
        returnValue: _i7.Future<List<_i4.CognitoDevice>>.value(
          <_i4.CognitoDevice>[],
        ),
      )
  ...
  _i7.Future<_i4.CognitoSignOutResult> signOut({_i4.SignOutOptions? options}) =>
      (super.noSuchMethod(
        Invocation.method(#signOut, [], {#options: options}),
  ...
  @override
  P cast<P extends _i3.AmplifyPluginInterface>() =>
      (super.noSuchMethod(
        Invocation.method(#cast, []),
        returnValue: _i6.dummyValue<P>(this, Invocation.method(#cast, [])),
      )
      as P);
  ...
  T reifyPluginOptions<T extends _i3.AWSDebuggable>({
    ...
    required T? defaultPluginOptions,
      ...
      (super.noSuchMethod(
        Invocation.method(#reifyPluginOptions, [], {
