...
void main() {
  ...
  testWidgets('SignUpScreen renders and has form fields', (WidgetTester tester) async {
    try {
                      ...
                      return MaterialApp(
                          ...
                          home: Builder(
                            builder: (context) {
                              ...
                              return Scaffold(body: SignupTextFieldsWidget(viewModel: provider));
                            }
                          ));
                    }),
              );
      ...
      expect(find.byType(SignupTextFieldsWidget), findsOneWidget);
      ...
      expect(find.text(S.of(provider.getContext()).setup_account), findsOneWidget);
    } catch (e) {
